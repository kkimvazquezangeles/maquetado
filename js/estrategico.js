function mostrar(){
                  ...
                  $("#svg_345").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_460").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  ...
                  $("#svg_606").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_648").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_685").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_723").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_766").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_808").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_857").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_892").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  ...
                  $("#svg_903").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_936").css({'fill':'none','stroke':'#E2E2E1'});
                  $("#svg_957").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_976").css({'fill':'none','stroke':'#E2E2E1'});
                  $("#svg_1012").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_1031").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  ...
                  $("#svg_1114").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_606").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_480").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  ...
                  $("#svg_1068").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1138").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_1164").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_903").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_936").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_976").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  ...
                  $("#svg_1189").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1248").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_1302").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_1350").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_480").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1493").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1542").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  ...
                  $("#svg_1414").css({'fill':'#FFFFFF','stroke':'#E2E2E1'});
                  $("#svg_1446").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1493").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_1542").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
                  $("#svg_428").css({'fill':'#E2E2E1','stroke':'#A09F9F'});
